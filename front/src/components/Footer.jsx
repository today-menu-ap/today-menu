...
const footerGridClass = 'container grid grid-cols-[1.6fr_repeat(4,1fr)] gap-[54px] max-lg:grid-cols-2 max-[540px]:grid-cols-2'
    ...
    <footer className={footerClass}>
      <div className={footerGridClass}>
        ...
        <div>
          ...
          <Link className={footerLinkClass} to="/menu">소개</Link>
          <Link className={footerLinkClass} to="/menu">이용 안내</Link>
          <Link className={footerLinkClass} to="/party">공지사항</Link>
          <Link className={footerLinkClass} to="/mypage">고객센터</Link>
        </div>

        <div>
          <h4 className={footerHeadingClass}>파트너</h4>
          <Link className={footerLinkClass} to="/menu">맛집 등록</Link>
          <Link className={footerLinkClass} to="/party">비즈니스 문의</Link>
        </div>

        <div>
          <h4 className={footerHeadingClass}>회사</h4>
          <Link className={footerLinkClass} to="/company">회사 소개</Link>
          <a className={footerLinkClass} href="#">채용 정보</a>
          <Link className={footerLinkClass} to="/terms" state={{ defaultTab: 'privacy' }}>개인정보 처리방침</Link>
          <Link className={footerLinkClass} to="/terms" state={{ defaultTab: 'terms' }}>이용약관</Link>
        </div>
